    ...
    <div className='flex justify-center pt-[50px]'>
      <div className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <>
            <div className="flex flex-col items-center pb-10">
              {user && user.avatar !== undefined &&
                <img className="w-32 h-24 mb-3 mt-3 rounded-full shadow-lg" src={`http://localhost:8000${user.avatar}`} alt={user.username} />
              }
            ...
            <div className='overflow-x-auto'>
              <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
                <thead className='text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400'>
                  <tr>
                    <th scope='col' className='px-4 py-3'>Travel Origin</th>
                    <th scope='col' className='px-4 py-3'>Travel Destination</th>
                ...
                <tbody>
                  {data && data.map((travel: Travel) => (
                    <tr key={travel.id} className='border-b dark:border-l-gray-700'>
          ...
          <div className='p-11'>
            <form onSubmit={handleSubmit}>
              ...
              <div className='p-3'>
                ...
                <input value={stateName} onChange={(e) => setStateName(e.target.value)} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Name' />
              </div>
              ...
              <div className='p-3'>
                ...
                <input value={stateLast} onChange={(e) => setStateLast(e.target.value)} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Last name' />
              </div>
        ...
        cursor-pointer bg-gray-40 ${isHovered ? "bg-gray-600" : "hover:bg-gray-600"
              ...
              <div className="flex mt-4 md:mt-6">
                <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save changes</button>
