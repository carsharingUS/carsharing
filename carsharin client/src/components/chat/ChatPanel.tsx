    ...
    const sendMessage = async () => {
        try {
            if (messageInput.trim() !== '') {
                await ChatService.sendMessage(user, messageInput, conversation[0].conversation);
                setMessageInput('');
            }
        } catch (error) {
    ...
    return (
        <div className="chat-panel">
            ...
            <div className="message-input">
                <input type="text" placeholder="Escribe un mensaje..." value={messageInput} onChange={(e) => setMessageInput(e.target.value)} />
